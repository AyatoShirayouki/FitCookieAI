...
namespace FitCookieAI_API.Controllers.Others
{
    ...
    [ApiController]
    public class PaymentPlanFeaturesController : ControllerBase
    {
        ...
        public PaymentPlanFeaturesController(IOptionsMonitor<JwtConfig> optionsMonitor, TokenValidationParameters tokenValidationParams, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<IActionResult> GetAll([FromHeader] string token, [FromHeader] string refreshToken)
        {
            if (token != null && refreshToken != null)
            {
                ...
                if (jwtAdminToken.JwtSuccess == true)
                {
                    ...
                    response.Body = await PaymentPlanFeaturesManagementService.GetAll();
        ...
        [HttpPost]
        [Route("Save")]
        public async Task<IActionResult> Save(PaymentPlanFeatureDTO PaymentPlanFeatureDTO, [FromHeader] string token, [FromHeader] string refreshToken)
        {
            if (PaymentPlanFeatureDTO == null || token == null || refreshToken == null)
            {
                response.Code = 400;
            ...
            else
            {
                ...
                if (jwtAdminToken.JwtSuccess == true)
                {
                    ...
                    await PaymentPlanFeaturesManagementService.Save(PaymentPlanFeatureDTO);
        ...
        public async Task<IActionResult> GetById(int id, [FromHeader] string token, [FromHeader] string refreshToken)
        {
            ...
            else
            {
                ...
                if (jwtAdminToken.JwtSuccess == true)
                {
                    ...
                    response.Body = await PaymentPlanFeaturesManagementService.GetById(id);
        ...
        public async Task<IActionResult> Delete(int id, [FromHeader] string token, [FromHeader] string refreshToken)
        {
            ...
            else
            {
                ...
                if (jwtAdminToken.JwtSuccess == true)
                {
                    ...
                    await PaymentPlanFeaturesManagementService.Delete(id);
